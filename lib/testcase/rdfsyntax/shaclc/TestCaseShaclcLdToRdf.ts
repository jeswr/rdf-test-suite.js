...
export class TestCaseShaclcToRdfHandler extends TestCaseEvalHandler {
  ...
  public static async wrap<H, T extends ITestCase<H>>(superHandler: (resource: Resource, testCaseData: ITestCaseData,
                                                      ...
                                                      options?: IFetchOptions): Promise<T> {
    const { injectArguments: injectArgumentsAdditional, testProperties } = await TestCaseShaclcToRdfHandler
