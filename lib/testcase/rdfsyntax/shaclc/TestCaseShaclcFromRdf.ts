...
export class TestCaseJsonLdFromRdfHandler implements ITestCaseHandler<TestCaseShaclcFromRdf> {

  public async resourceToTestCaseInner(resource: Resource, testCaseData: ITestCaseData,
                                       options?: IFetchOptions): Promise<TestCaseShaclcFromRdf> {
    ...
    return new TestCaseShaclcFromRdf(testCaseData,
  ...
  public async resourceToTestCase(resource: Resource, testCaseData: ITestCaseData,
                                  options?: IFetchOptions): Promise<TestCaseShaclcFromRdf> {
    return TestCaseShaclcToRdfHandler.wrap(this.resourceToTestCaseInner.bind(this), resource, testCaseData, options);
  }

}

export class TestCaseShaclcFromRdf implements ITestCaseFromRdfSyntax {
